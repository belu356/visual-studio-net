...
Partial Public Class colegioDataSet
    ...
    Partial Public Class alumnosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddalumnosRow(ByVal apellido As String, ByVal nombre As String, ByVal edad As Integer) As alumnosRow
            Dim rowalumnosRow As alumnosRow = CType(Me.NewRow,alumnosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, apellido, nombre, edad}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindBylegajo(ByVal legajo As Integer) As alumnosRow
            Return CType(Me.Rows.Find(New Object() {legajo}),alumnosRow)
        End Function
    ...
    Partial Public Class alumnosRow
        ...
        Public Property legajo() As Integer
            Get
                Return CType(Me(Me.tablealumnos.legajoColumn),Integer)
            End Get
            Set
                Me(Me.tablealumnos.legajoColumn) = value
            End Set
        End Property
...
Namespace colegioDataSetTableAdapters
    ...
    Partial Public Class alumnosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[alumnos] WHERE (([legajo] = @Original_legajo) AND ((@IsNull_ap"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[alumnos] ([apellido], [nombre], [edad]) VALUES (@apellido, @no"& _ 
                "mbre, @edad);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT legajo, apellido, nombre, edad FROM alumnos WHERE (legajo "& _ 
                "= SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[alumnos] SET [apellido] = @apellido, [nombre] = @nombre, [edad] = @"& _ 
                "edad WHERE (([legajo] = @Original_legajo) AND ((@IsNull_apellido = 1 AND [apelli"& _ 
                "do] IS NULL) OR ([apellido] = @Original_apellido)) AND ((@IsNull_nombre = 1 AND "& _ 
                "[nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_edad = 1 AND ["& _ 
                "edad] IS NULL) OR ([edad] = @Original_edad)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT legajo, apellido, nombre,"& _ 
                " edad FROM alumnos WHERE (legajo = @legajo)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApplication1.My.MySettings.Default.colegioConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT legajo, apellido, nombre, edad FROM dbo.alumnos"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_legajo As Integer, ByVal Original_apellido As String, ByVal Original_nombre As String, ByVal Original_edad As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal apellido As String, ByVal nombre As String, ByVal edad As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal apellido As String, ByVal nombre As String, ByVal edad As Global.System.Nullable(Of Integer), ByVal Original_legajo As Integer, ByVal Original_apellido As String, ByVal Original_nombre As String, ByVal Original_edad As Global.System.Nullable(Of Integer), ByVal legajo As Integer) As Integer
            If (apellido Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_legajo,Integer)
            If (Original_apellido Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(10).Value = CType(legajo,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal apellido As String, ByVal nombre As String, ByVal edad As Global.System.Nullable(Of Integer), ByVal Original_legajo As Integer, ByVal Original_apellido As String, ByVal Original_nombre As String, ByVal Original_edad As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(apellido, nombre, edad, Original_legajo, Original_apellido, Original_nombre, Original_edad, Original_legajo)
        End Function
    End Class
